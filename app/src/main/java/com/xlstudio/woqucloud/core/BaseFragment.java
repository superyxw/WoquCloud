...
//        authCode = SPUtil.getAuthCode(getActivity());

//        swLay = (SwipeRefreshLayout)self.findViewById(R.id.swipe_refresh_layout);
//
//        if(swLay!=null){
//
//            swLay.setColorSchemeResources(R.color.blue);
//
//            swLay.setProgressViewOffset(false, 0, DeviceInfo.dip2px(getActivity(), 24));
//
...
//        }
    ...
    public void setTitle(String title){
        TextView titleView = (TextView)self.findViewById(R.id.mTitle);
        if (null != title) {

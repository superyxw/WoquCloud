 ...
 */
public abstract class BaseFragmentActivity extends FragmentActivity implements SwipeRefreshLayout.OnRefreshListener{

    public SwipeRefreshLayout swLay;
...
//        swLay = (SwipeRefreshLayout)findViewById(R.id.swipe_refresh_layout);
//
//        if(swLay!=null){
//
//            swLay.setColorSchemeResources(R.color.blue);
//
//            swLay.setProgressViewOffset(false, 0, DeviceInfo.dip2px(this, 24));
//
//            swLay.setOnRefreshListener(this);
//
//        }
...
//	        getWindow().addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_NAVIGATION);
            ...
            int statusHeight = DeviceInfo.getStatusBarHeight(this);

            findViewById(R.id.rl_head_common).setPadding(0, statusHeight, 0, 0);
    ...
    protected void setTitle(String title) {
        TextView titleView = (TextView) findViewById(R.id.mTitle);
        if (null != title) {
